...
```bash
cd a2o/golden/src/verilog && verilator --lint-only --language 1364-2005 ... work/mmq.v   # 3
cd a2o/rel/src/verilog    && verilator --lint-only --language 1364-2005 ... work/mmq.v   # 3
```

The golden tree (`a2o/golden/`) is a byte-identical snapshot of upstream, kept precisely so
this comparison stays meaningful regardless of how many commits have landed.
